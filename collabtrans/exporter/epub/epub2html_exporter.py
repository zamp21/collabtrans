...
from collabtrans.exporter.epub.base import EpubExporter
...
if __name__ == '__main__':
    ...
    Path(r"C:\Users\jxgm\Desktop\translate\collabtrans\tests\output\output.html").write_bytes(html_exp.content)