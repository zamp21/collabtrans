...
- **インタラクティブUI**: サービス起動後、ブラウザで `http://127.0.0.1:8020` (または指定したポート) にアクセスしてください。
- **APIドキュメント**: 完全なAPIドキュメント (Swagger UI) は `http://127.0.0.1:8020/docs` にあります。
