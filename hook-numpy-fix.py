...
def _install_overrides_stub():
    ...
    try:
        ...
        print('✅ Installed numpy._core.overrides stub (safe add_docstring)')
    except Exception as e:
        print(f'⚠️ Failed to install overrides stub: {e}')
...
if hasattr(sys, 'frozen'):
    ...
    try:
        ...
        print('✅ Ensured overrides stub for both numpy.core.overrides and numpy._core.overrides')
    except Exception as _e:
        print(f'⚠️ Failed to mirror overrides stub: {_e}')
