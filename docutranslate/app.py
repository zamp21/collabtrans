...
# --- 认证模块 Imports ---
try:
    from docutranslate.auth import AuthConfig, AuthMiddleware, auth_router, auth_compat_router, init_auth
    AUTH_AVAILABLE = True
    print("认证模块导入成功")
...
if AUTH_AVAILABLE:
    try:
        ...
        # 获取会话管理器和配置
        from docutranslate.auth import get_session_manager, get_auth_config
